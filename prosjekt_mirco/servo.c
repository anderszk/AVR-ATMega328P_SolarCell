...
>>>>>>> ce1a85a3c5e74628c127a636687a6bf60f0ebe57
...
// OCR1A = SERVO_MIN; // Manual setting to 0Â° for testing

// OCR1A = (SERVO_MAX+SERVO_MIN)/2; // Manual setting to 90Â° for testing

// OCR1A = SERVO_MAX; // Manual setting to 180Â° for testing
...
=======
	...
	do {
		...
		// Test code for finding endpoints
...
/*! ADC initialization. Pre-scaler 128x, resulting in 125kHz ADC clock @ 16MHz.
